...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddLockFreeGuidFactory(
    ...
    /// </summary>
    public static IServiceCollection AddHlcGuidFactory(
        this IServiceCollection services,
        ushort nodeId = 0,
...
public static class GuidExtensions
{
    ...
    /// </summary>
    public static long? GetTimestampMs(this Guid guid)
    {
    ...
    /// Returns null if not a valid UUIDv7.
    /// </summary>
    public static ushort? GetCounter(this Guid guid)
    {
        Span<byte> bytes = stackalloc byte[16];
        guid.TryWriteBytes(bytes, bigEndian: true, out _);
    ...
    /// </summary>
    public static ushort? GetNodeId(this Guid guid)
    {
        Span<byte> bytes = stackalloc byte[16];
        guid.TryWriteBytes(bytes, bigEndian: true, out _);
    ...
    /// </summary>
    public static bool IsVersion7(this Guid guid)
    {
        Span<byte> bytes = stackalloc byte[16];
        guid.TryWriteBytes(bytes, bigEndian: true, out _);
    ...
    /// </summary>
    public static int CompareByTimestamp(this Guid left, Guid right)
    {
    ...
    /// </summary>
    public static HlcTimestamp? ToHlcTimestamp(this Guid guid)
    {
        if (!guid.IsVersion7())
            return null;
...
public static class TimeProviderExtensions
{
    ...
    /// </summary>
    public static Guid CreateVersion7(this TimeProvider timeProvider)
        => Guid.CreateVersion7(timeProvider.GetUtcNow());

    /// <summary>
    /// Gets the current Unix timestamp in milliseconds.
    /// </summary>
    public static long GetUnixTimeMilliseconds(this TimeProvider timeProvider)
